...
export const classStreams: ClassStream[] = [
  {
    id: "BENG24COE-1",
    label: "BENG24COE-1",
    description: "Day stream · morning & afternoon",
  },
  {
    id: "BENG24COE-2",
    label: "BENG24COE-2",
    description: "Evening stream · late sessions",
    isEvening: true,
  },
  {
    id: "BENG24COE-3",
    label: "BENG24COE-3",
    description: "Day stream · alternate rooms",
  },
  {
    id: "BENG24COE-4",
    label: "BENG24COE-4",
    description: "Day stream · Lab-heavy week",
  },
];

export const DEFAULT_CLASS_STREAM: ClassStreamId = "BENG24COE-1";
...
export const timetable: TimetableEntry[] = [
  ...
  },
  {
    id: "tt-4-5",
    streamId: "BENG24COE-4",
    moduleId: "mod-numerical",
    day: 3,
    startTime: "15:00",
    endTime: "17:00",
    room: "LT 5",
    lecturer: "Dr. James Mwita",
  },
  {
    id: "tt-4-6",
    streamId: "BENG24COE-4",
...
export function getTimetableForStream(streamId: ClassStreamId) {
  return timetable.filter((entry) => entry.streamId === streamId);
}
